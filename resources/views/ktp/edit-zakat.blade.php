...
<div class="container-fluid" style="margin-top:4em;">
    <div class="card">
        ...
        <div class="table-responsive">
            <form  action="{{ route('update-zakat', ['id' => $donation->id]) }}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="container">
                    @isset($donation)
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" id="Nominal" class="form-control" name="nominal" oninput="formatNumber(this)" required value="{{ $donation->nominal }}" value="{{ $donation->nominal }}">
                        </div>
